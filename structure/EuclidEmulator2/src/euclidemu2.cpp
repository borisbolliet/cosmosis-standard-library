...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "extra_compile_args": [
            "-std=c++11",
            "-D PRINT_FLAG=0",
            "-D PATH_TO_EE2_DATA_FILE=\"/Users/boris/Work/CLASS-SZ/SO-SZ/cosmosis-standard-library/structure/EuclidEmulator2/ee2_bindata.dat\""
        ],
        "extra_link_args": [
            "-L /Users/boris/Work/CLASS-SZ/SO-SZ/env/lib -lgslcblas -lgsl"
        ],
        "include_dirs": [
            "src",
            "/Users/boris/Work/CLASS-SZ/SO-SZ/env/include",
            "../src/"
        ],
        "language": "c++",
        "libraries": [
